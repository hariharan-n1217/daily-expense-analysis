...
function App() {
  // Enhanced Multi-Page Navigation State (Default to Home Dashboard)
  ...
  // Formatting savings data for the animated chart component
  const chartData = [
    { month: '1 Month', amount: forecast.m1 },
    { month: '6 Months', amount: forecast.m6 },
    { month: '1 Year', amount: forecast.y1 },
    { month: '2 Years', amount: forecast.y2 },
    { month: '3 Years', amount: forecast.y3 },
  ];
  ...
  return (
    <div className="app-container">
      {/* MAIN HUB INTERFACE WITH ANIMATED TABS */}
      ...
      <div className="view-transition-wrapper">
        ...
        {/* VIEW C: SAVINGS HUB WITH RECHARTS ANIMATED GRAPH */}
        {view === 'savings' && (
          <div className="page-padding main-content-grid animated-view">
            ...
            {/* SIMULATION VISUALIZER & ANIMATED GRAPH PANEL */}
            <section className="panel-card" style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
              ...
              <SavingsGraph savingsData={chartData} />
            </section>
          </div>
        )}
      ...
      {/* FOOTER PANEL */}
      <footer style={{ marginTop: 'auto', background: '#12111f', padding: '1.5rem 2rem', borderTop: '2px solid #242238', boxShadow: '0 -4px 20px rgba(0, 0, 0, 0.3)', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: '1.25rem' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
          <span style={{ fontSize: '1rem', fontWeight: 900, color: '#00f0ff', letterSpacing: '0.02em' }}>Developer Profile: S. HARIHARAN</span>
          <span style={{ fontSize: '0.85rem', color: '#8a88a3' }}>BSc Computer Science</span>
        </div>
